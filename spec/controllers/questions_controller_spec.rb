...
RSpec.describe QuestionsController, type: :controller do
  ...
  describe "QUESTION create" do
    it "increases the number of question by 1" do
      expect{question :create, question: {title: RandomData.random_sentence, body: RandomData.random_paragraph, RandomData.random_resolved}}.to change(Question,:count).by(1)
    end

    it "assigns the new question to @question" do
      question :create, question: {title: RandomData.random_sentence, body: RandomData.random_paragraph, RandomData.random_resolved}
  ...
  describe "PUT update" do
     it "updates question with expected attributes" do
       ...
       new_boolean = RandomData.random_resolved
